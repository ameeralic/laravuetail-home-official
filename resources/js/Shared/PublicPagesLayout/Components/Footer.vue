<template>
    <div class="bg-zinc-600 h-48 z-50">
        <div class="md:max-w-6xl py-10 mx-auto flex justify-end px-2 items-center">
            <div>
                <img src="https://laravuetail.com/images/laravuetail-logo.png" alt="" class="h-10 w-10 hidden xl:block">
